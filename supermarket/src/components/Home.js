...
export const Home = () => {
    ...
    return (
        <div>
            <section className="mt-lg-12 mb-lg-14 mb-8 mt-8">
                <div className="container-fluid">
                    <Carousel showThumbs={false}
                        ...
                        showStatus
                        autoPlay >
                        <div style={{ background: 'url(./assets/images/slider/hero-img-slider-1.jpg)no-repeat', backgroundSize: "cover", borderRadius: ".5rem", backgroundPosition: "center", textAlign: "left" }}>
                            <div className="ps-lg-12 py-lg-16 col-xxl-5 col-lg-7 col-md-8 py-14 px-8 text-xs-center">
                                <h1 className="text-white display-5 fw-bold mt-4">SuperMarket For Fresh Grocery </h1>
                                <p className="lead text-white">Introduced a new model for online grocery shopping
                        ...
                        <div style={{ background: 'url(./assets/images/slider/hero-img-slider-2.jpg)no-repeat', backgroundSize: "cover", borderRadius: ".5rem", backgroundPosition: "center", textAlign: "left" }}>
                            <div className="ps-lg-12 py-lg-16 col-xxl-5 col-lg-7  col-md-8 py-14 px-8 text-xs-center">

                                <h1 className=" display-5 fw-bold mt-4">Opening Sale<br />
                                    Discount up to <span className="text-primary display-6">50%</span></h1>
                                <p className="lead ">Snack on late-night munchies of delicious nuts & you’re guaranteed
                        ...
                        <div style={{ background: 'url(./assets/images/slider/hero-img-slider-3.jpg)no-repeat', backgroundSize: "cover", borderRadius: ".5rem", backgroundPosition: "center", textAlign: "left" }}>
                            <div className="ps-lg-12 py-lg-16 col-xxl-5 col-lg-7  col-md-8 py-14 px-8 text-xs-center">

                                <h1 className=" display-5 fw-bold mt-4">Midnight Munch Combo </h1>
                                <p className="lead ">Snack on late-night munchies of delicious nuts & you’re guaranteed
                                    happiness before you doze!
                                </p>
                                <Link to="#!" className="btn btn-dark mt-3">Shop Now <i
            ...
            <div className="mt-lg-12 mb-lg-14 mb-8 mt-8">
                <div className="container-fluid">
                    <div className="row ">
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <div className="card">
                                                    <ul className="nav nav-category" id="categoryCollapseMenu">
                                                        <li className="nav-item border-bottom w-100 collapsed px-4 py-1">
                                                            <Link className="nav-link" data-bs-toggle="collapse"
                                                                ...
                                                                <span className="d-flex align-items-center">
                                                                    ...
                                                                    <span className="ms-2">Dairy, Bread & Eggs</span>
                                                                </span><i className="fa fa-arrow-right"></i></Link>
                                                        ...
                                                        <li className="nav-item border-bottom w-100 collapsed px-4 py-1"><Link
                                                        ...
                                                        <li className="nav-item border-bottom w-100 collapsed px-4 py-1">
                                                            <Link className="nav-link" data-bs-toggle="collapse"
                                                                ...
                                                                <span className="d-flex align-items-center">
                                                                    ...
                                                                    <span className="ms-2">Cold Drinks & Juices </span>
                                                                </span>
                                                                <i className="fa fa-arrow-right"></i></Link>
                                                        ...
                                                        <li className="nav-item border-bottom w-100 collapsed px-4 py-1">
                                                            <Link className="nav-link" data-bs-toggle="collapse"
                                                                ...
                                                                <span className="d-flex align-items-center">
                                                                    ...
                                                                    <span className="ms-2"> Bakery & Biscuits</span>
                                                                </span>
                                                                <i className="fa fa-arrow-right"></i></Link>
                                                        ...
                                                        <li className="nav-item w-100 collapsed px-4 py-1">
                                                            <Link className="nav-link" data-bs-toggle="collapse"
                                                                ...
                                                                <span className="d-flex align-items-center">
                                                                    ...
                                                                    <span className="ms-2"> Chicken, Meat & Fish</span>
                                                                </span>
                                                                <i className="fa fa-arrow-right"></i></Link>
