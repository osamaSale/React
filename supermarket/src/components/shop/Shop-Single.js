                            ...
                            <div className="ps-lg-10 mt-6 mt-md-0">
                                ...
                                <div className="mt-3 row justify-content-start g-2 align-items-center">
                                    ...
                                    <div className="col-md-4 col-4">
                                        ...
                                        <Link className="btn btn-light" to="#" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Compare"><i className="bi bi-arrow-left-right"></i></Link>
                                        <Link className="btn btn-light" to="shop-wishlist.html" data-bs-toggle="tooltip" data-bs-html="true" aria-label="Wishlist"><i className="feather-icon icon-heart"></i></Link>
                                    </div>
                                </div>
