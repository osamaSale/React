...
const Footer = () => {
    ...
    return (
        <div>
            <footer className="footer border-top bg-secondary text-light">
                <div className="container-fluid">
                    <div className="row align-items-center">
                        <div className="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
                            <button className='btn btn-dark me-4'>MAGAZINE</button>
                            <button className='btn text-light  me-4'>FAQ</button>
                            <button className='btn text-light  me-4'>About Us</button>
                        </div>
                        <div className="col-lg-7 mt-4 mt-md-0">
                            <ul className="list-inline text-md-end mb-0 small mt-3 mt-md-0">
                              
                                <li className="list-inline-item me-1">
                                    <Link className="btn btn-xs btn-social btn-icon"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
