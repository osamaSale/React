                ...
                <div className="h-200px rounded-top" style={{backgroundImage:'url(assets/images/bg/05.jpg)', backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}></div>
                  ...
                  <div className="card-footer mt-3 pt-2 pb-0">
                    ...
                    <ul className="nav nav-bottom-line align-items-center justify-content-center justify-content-md-start mb-0 border-0">
                      <li className="nav-item"> <Link className="nav-link active" to="my-profile.html"> Posts </Link> </li>
                      <li className="nav-item"> <Link className="nav-link" to="my-profile-about.html"> About </Link> </li>
                      <li className="nav-item"> <Link className="nav-link" to="my-profile-connections.html"> Connections <span className="badge bg-success bg-opacity-10 text-success small"> 230</span> </Link> </li>
                      <li className="nav-item"> <Link className="nav-link" to="my-profile-media.html"> Media</Link> </li>
                      <li className="nav-item"> <Link className="nav-link" to="my-profile-videos.html"> Videos</Link> </li>
                      <li className="nav-item"> <Link className="nav-link" to="my-profile-events.html"> Events</Link> </li>
                      <li className="nav-item"> <Link className="nav-link" to="my-profile-activity.html"> Activity</Link> </li>
                    </ul>
                  </div>
                </div>
