                ...
                <div className="container">
                        ...
                        <ul className="navbar-nav navbar-nav-scroll ms-auto">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="homeMenu">
                                    ...
                                    <li> <Link className="dropdown-item" to="landing.html">Landing page </Link></li>
                                    <li> <Link className="dropdown-item" to="app-download.html">App download </Link></li>
                                ...
                                <ul className="dropdown-menu" aria-labelledby="pagesMenu">
                                    ...
                                    <li className="dropdown-submenu dropend">
                                        ...
                                        <ul className="dropdown-menu" data-bs-popper="none">
                                            ...
                                            <li> <Link className="dropdown-item" to="my-profile-videos.html">Videos </Link> </li>
                                            <li> <Link className="dropdown-item" to="my-profile-events.html">Events </Link> </li>
                                            <li> <Link className="dropdown-item" to="my-profile-activity.html">Activity </Link> </li>
                                        </ul>
                                    </li>
                                    <li> <Link className="dropdown-item" to="events.html">Events </Link></li>
                                    <li> <Link className="dropdown-item" to="events-2.html">Events 2 </Link></li>
                                    <li> <Link className="dropdown-item" to="event-details.html">Event details </Link></li>
                                    <li> <Link className="dropdown-item" to="event-details-2.html">Event details 2 </Link></li>
                                    <li> <Link className="dropdown-item" to="groups.html">Groups </Link></li>
                                    <li> <Link className="dropdown-item" to="group-details.html">Group details </Link></li>
                                    <li> <Link className="dropdown-item" to="post-videos.html">Post videos </Link></li>
                                    <li> <Link className="dropdown-item" to="post-video-details.html">Post video details </Link></li>
                                    <li> <Link className="dropdown-item" to="post-details.html">Post details </Link></li>
                                    <li> <Link className="dropdown-item" to="video-details.html">Video details </Link></li>
                                    <li> <Link className="dropdown-item" to="blog.html">Blog </Link></li>
                                    <li> <Link className="dropdown-item" to="blog-details.html">Blog details </Link></li>
                    ...
                    <ul className="nav flex-nowrap align-items-center ms-sm-3 list-unstyled">
                        ...
                        <li className="nav-item dropdown ms-2">
                            <Link className="nav-link bg-light icon-md btn btn-light p-0" to="#" id="notifDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                        ...
                        <li className="nav-item ms-2 dropdown">
                            ...
                            <ul className="dropdown-menu dropdown-animation dropdown-menu-end pt-3 small me-md-n3" aria-labelledby="profileDropdown">
                                ...
                                <li>
                                    <Link className="dropdown-item" to="docs/index.html" target="_blank">
                                        <i className="fa-fw bi bi-card-text me-2"></i>Documentation
                                    </Link>
                                </li>
                                <li className="dropdown-divider"></li>
                                <li><Link className="dropdown-item bg-danger-soft-hover" to="sign-in-advance.html"><i className="bi bi-power fa-fw me-2"></i>Sign Out </Link></li>
                                <li> <hr className="dropdown-divider" /></li>

                                <li>
                                    <div className="modeswitch-item theme-icon-active d-flex justify-content-center gap-3 align-items-center p-2 pb-0">
                                        <span>Mode:</span>
                                        <button type="button" className={`btn btn-modeswitch nav-link text-primary-hover mb-0 ${theme === "light" ? "active" : ""}`} data-bs-theme-value="light" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Light"
                                        ...
                                        <button type="button" className={`btn btn-modeswitch nav-link text-primary-hover mb-0 ${theme === "dark" ? "active" : ""}`} data-bs-theme-value="dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Dark" onClick={() => setTheme('dark')}>
                                        ...
                                        <button type="button" className={`btn btn-modeswitch nav-link text-primary-hover mb-0 ${theme === "auto" ? "active" : ""}`} data-bs-theme-value="auto" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Auto" onClick={() => setTheme('auto')}>
