        ...
        <nav className="navigation d-flex flex-column text-center navbar navbar-light hide-scrollbar">
            ...
            <ul className="d-flex nav navbar-nav flex-row flex-xl-column flex-grow-1 justify-content-between justify-content-xl-center align-items-center w-100 py-4 py-lg-2 px-lg-3" role="tablist">
                ...
                <li className="nav-item">
                    <Link className="nav-link py-0 py-lg-8" id="tab-create-chat" to="#tab-content-create-chat" title="Create chat" data-bs-toggle="tab" role="tab">
                        <div className="icon icon-xl">
                ...
                <li className="nav-item">
                    <Link className="nav-link py-0 py-lg-8" id="tab-friends" to="#tab-content-friends" title="Friends" data-bs-toggle="tab" role="tab">
                        <div className="icon icon-xl">
                ...
                <li className="nav-item">
                    <Link className="nav-link active py-0 py-lg-8" id="tab-chats" to="#tab-content-chats" title="Chats" data-bs-toggle="tab" role="tab">
                ...
                <li className="nav-item">
                    <Link className="nav-link py-0 py-lg-8" id="tab-notifications" to="#tab-content-notifications" title="Notifications" data-bs-toggle="tab" role="tab">
                        <div className="icon icon-xl">
                ...
                <li className="nav-item d-none d-xl-block flex-xl-grow-1">
                    <Link className="nav-link py-0 py-lg-8" id="tab-support" to="#tab-content-support" title="Support" data-bs-toggle="tab" role="tab">
                        <div className="icon icon-xl">
