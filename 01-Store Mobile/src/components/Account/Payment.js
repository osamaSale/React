                        ...
                        <div className="col-lg-9 col-md-8 col-12">
                            <div className="py-6 p-md-6 p-lg-10">
                                ...
                                <div className="d-flex justify-content-between mb-6 align-items-center">
                                    ...
                                    <Link  to="#" className="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#paymentModal">Add Payment</Link>
                                </div>
                                    ...
                                    <li className="list-group-item py-5 px-0">
                                        <div className="d-flex justify-content-between">
                                            ...
                                            <div>
                                                ...
                                                <Link to="#" className="btn btn-outline-gray-400 disabled btn-sm">Remove</Link>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li className="list-group-item px-0 py-5">
                                        <div className="d-flex justify-content-between">
                                            ...
                                            <div>
                                                ...
                                                <Link  to="#" className="btn btn-outline-gray-400 text-muted btn-sm">Remove</Link>
                                            </div>
                                        </div>
                                    </li>
