...
import { deleteDevices } from "../../../redux/api/devices"
                        ...
                        <div className="mb-1">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb mb-0">
                                    ...
                                    <li className="breadcrumb-item ">{devices && devices.length > 0 ? devices.length : 0}</li>
                                </ol>
                            </nav>
                        </div>
                        <div>
                        ...
                        <div className="px-2 py-6">
                            <div className="row d-flex justify-content-between">
                                ...
                                <div className="col-md-2 d-flex justify-content-end">
                                    <Link className="btn btn-primary w-100" onClick={() => setOpenDevice(true)}><i className="bi bi-plus me-2"></i>Add Device</Link>
                                </div>
                            </div>
                        </div>
