...
import { deleteUser, searchUser } from "../../../redux/api/users"
import { PDFDownloadLink } from '@react-pdf/renderer';
import { PDFUsers } from '../PDF/PDFUsers';
...
export const Users = ({ update }) => {
    ...
    const header = ["ID", "Name", "Email", "Password", "Image", "Phone", "Authorization", 'cloudinary_id'];
    ...
    return (
        <section className="container">
            <div className="hstack gap-3 mb-4">
                <div className="">
                    <h4>Users / <Link className="text-inherit"> {users && users.length > 0 ? users.length : 0}</Link></h4>
                </div>
                ...
                <div className="ms-auto">
                    <div className="dropdown">
                        ...
                        <ul className="dropdown-menu">
                            <li>
                                <PDFDownloadLink document={<PDFUsers users={users} />} fileName="somename.pdf" className="dropdown-item">
            ...
            <div className="row">
                <div className="col-xl-12 col-12 mb-2">
                        ...
                        <div className="px-2 py-6">
                            <div className="row d-flex justify-content-between">
                                ...
                                <div className='col-md'>
                                    <Link className="btn btn-primary w-100" onClick={() => setOpenUser(true)}><i className="bi bi-plus-lg me-2"></i>Add User</Link>
                                </div>
                            </div>
                        </div>
