...
export const Navbar = ({ update, exampleModal, modal }) => {
                        ...
                        <div className="d-flex align-items-center justify-content-between ms-4">
                            ...
                            <div className="text-center ms-6">
                                <Link data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" to="#offcanvasExample"
                                     aria-controls="offcanvasRight" className="text-reset">
                            ...
                            <div className=" text-center">
                                ...
                                {user ?
                                    <Link className="text-reset "  data-bs-toggle="dropdown" aria-expanded="false">
                                        <div className="lh-1">
                                            <div className="mb-2">
                                                <img src={user && user.image} alt='' className="rounded-circle fs-4"  />
                                            </div>
                                                ...
                                                <div className="dropdown-menu-list-submenu">
                                                    <div>
                                                        ...
                                                        <ul className="list-unstyled">
                                                            <li>
                                                                <Link className="dropdown-item">Fresh Vegetables</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Herbs &amp; Seasonings</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Fresh Fruits</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Organic Fruits &amp; Vegetables</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Cuts &amp; Sprouts</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Exotic Fruits &amp; Veggies</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Flower Bouquets, Bunches</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Specialty</Link>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <ul className="list-unstyled">
                                                            <li>
                                                                <Link className="dropdown-item">Banana &amp; Papaya</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Kiwi, Citrus Fruit</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Apples &amp; Pomegranate</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Seasonal Fruits</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Mangoes</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Fruit Baskets</Link>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <li className="dropdown-menu-list">
                                                <Link className="dropdown-item d-flex justify-content-between mb-1 py-1 ">
                                                    <div>
                                                        ...
                                                        <span className="ms-1">Snack &amp; Munchies</span>
                                                    </div>
                                                    <div>
                                                ...
                                                <div className="dropdown-menu-list-submenu">
                                                    <div>
                                                        ...
                                                        <ul className="list-unstyled">
                                                            <li>
                                                                <Link className="dropdown-item">Chips &amp; Crisps</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Nachos</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Popcorn</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Bhujia &amp; Mixtures</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Namkeen Snacks</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Healthy Snacks</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Cakes &amp; Rolls</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Energy Bars</Link>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <ul className="list-unstyled">
                                                            <li>
                                                                <Link className="dropdown-item">Papad &amp; Fryums </Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Glucose &amp; Milk Biscuits</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Glucose &amp; Milk Biscuits</Link>
                                                            </li>
                                            ...
                                            <li className="dropdown-menu-list">
                                                <Link className="dropdown-item d-flex justify-content-between mb-1 py-1 ">
                                                    <div>
                                                        ...
                                                        <span className="ms-1">Bakery &amp; Biscuits</span>
                                                    </div>
                                                    <div>
                                                        <i className="feather-icon icon-chevron-right"></i>
                                                    </div>
                                                ...
                                                <div className="dropdown-menu-list-submenu">
                                                    <div>
                                                        ...
                                                        <ul className="list-unstyled">
                                                            <li>
                                                                <Link className="dropdown-item">Cookies</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Glucose &amp; Marie</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Sweet &amp; Salty</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Healthy &amp; Digestive</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Cream Biscuits</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Rusks &amp; Wafers</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Cakes &amp; Rolls</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Buns &amp; Bakery</Link>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <div className="dropdown-menu-list-submenu">
                                                    <div>
                                                        ...
                                                        <ul className="list-unstyled">
                                                            ...
                                                            <li>
                                                                <Link className="dropdown-item">Energy Drinks</Link>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <Link className="dropdown-item">Concentrates &amp; Syrups</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Detox &amp; Energy Drinks</Link>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <ul className="list-unstyled">
                                                            <li>
                                                                <Link className="dropdown-item">Juice Collection</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Concentrates &amp; Syrups</Link>
                                                            </li>
                                            ...
                                            <li className="dropdown-menu-list">
                                                <Link className="dropdown-item d-flex justify-content-between mb-1 py-1">
                                                    <div>
                                                        ...
                                                        <span className="ms-1">Dairy, Bread &amp; Eggs</span>
                                                    </div>
                                                    <div>
                                                        <i className="feather-icon icon-chevron-right"></i>
                                                    </div>
                                                ...
                                                <div className="dropdown-menu-list-submenu">
                                                    <div>
                                                        ...
                                                        <ul className="list-unstyled">
                                                            <li>
                                                                <Link className="dropdown-item">Milk</Link>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <Link className="dropdown-item">Butter &amp; More</Link>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <div>
                                                        ...
                                                        <ul className="list-unstyled">
                                                            <li>
                                                                <Link className="dropdown-item">Paneer &amp; Tofu</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Cream &amp; Whitener</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Condensed Milk</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Vegan Drinks</Link>
                                                            </li>
                                            ...
                                            <li className="dropdown-menu-list  ">
                                                <Link className="dropdown-item d-flex justify-content-between mb-1 py-1 ">
                                                    <div>
                                                        ...
                                                        <span className="ms-1">Chicken, Meat &amp; Fish</span>
                                                    </div>
                                                    <div>
                                                        <i className="feather-icon icon-chevron-right"></i>
                                                    </div>
                                                ...
                                                <div className="dropdown-menu-list-submenu ">
                                                    <div>
                                                        ...
                                                        <ul className="list-unstyled">
                                                            <li>
                                                                <Link className="dropdown-item">Chicken</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Sausage, Salami &amp; Ham</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Exotic Meat</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Eggs</Link>
                                                            </li>
                                            ...
                                            <li className="dropdown-menu-list  ">
                                                ...
                                                <div className="dropdown-menu-list-submenu">
                                                    <div>
                                                        ...
                                                        <ul className="list-unstyled">
                                                            <li>
                                                                <Link className="dropdown-item">Diapers, Wipes &amp; More
                                                                </Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Baby Food</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Bath &amp; Hair Care
                                                                </Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Oral &amp; Nasal Care
                                                                </Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Baby Skin Care Online</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Cleaning Needs Online</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Feeding Accessories Online</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Baby Pharma</Link>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <ul className="list-unstyled">
                                                            <li>
                                                                <Link className="dropdown-item">Mother Care</Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Baby Gift Set </Link>
                                                            </li>
                                                            <li>
                                                                <Link className="dropdown-item">Kids Toys &amp; More </Link>
                                                            </li>
